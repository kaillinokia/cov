...
# Refer to README.DC-RM.txt on using ${DCRM_DFT_SIGNAL_SETUP_INPUT_FILE} to define the DFT signals in your design.
# The default name of the file is ${DESIGN_NAME}.dft_signal_defs.tcl 
#
