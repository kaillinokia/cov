...
set RTL_SOURCE_FILES_SV    "filelist_sv.f"  ;# Enter the list of source RTL files if reading from RTL
set RTL_SOURCE_FILES_VLOG  "filelist_v.f"   ;# Enter the list of source RTL files if reading from RTL
set RTL_SOURCE_FILES_VHDL  "filelist_vhd.f" ;# Enter the list of source RTL files if reading from RTL
...
set ICC2LINK_FLOW "TRUE" 

## Set the varible to TRUE to enable NDM Flow in DCNXT. { TRUE FALSE }
set NDM_FLOW "TRUE"

## Set the varible to 5 or 7 for the technology that you want (5nm or 7nm)
set NODE "5"

## Set the varible to TRUE if you can to enable scan/test mode for DFT insertion during the synthesis
set USE_SCAN "FALSE"

## Set this variable to dump congestion maps/reports 
set REPORT_CONGESTION "FALSE"

#Set this variable to run synthesis without ungrouping any hierarchies
set NO_AUTOUNGROUP "TRUE"
